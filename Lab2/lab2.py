...
elif healingPotion == 1 and healthPoints < 5:
    healingPotion = 0
    healthPoints = 6
...
# subtracting 1 from the diceOptions as arrays are indexed starting from 0
weaponRoll = random.choice(diceOptions) - 1

combatStrength = combatStrength + weaponRoll

print("The weapon rolled was: " + weapons[weaponRoll])
